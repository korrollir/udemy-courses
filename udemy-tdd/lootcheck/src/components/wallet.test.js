...
/* Importing bare, unconnected to redux component for testing */
import { Wallet } from './Wallet'

describe('Wallet', () => {
  /* Emulates a deposit being made to the balance */
  ...
  describe('when the user types into the wallet input', () => {
    ...
    describe('and the user wants to make a withdrawal', () => {
      ...
      it('dispatches the `withdraw()` it receves from props with the local balance', () => {
